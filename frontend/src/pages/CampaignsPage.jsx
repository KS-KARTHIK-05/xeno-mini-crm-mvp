  ...
  return (
    <div className="min-h-full" style={{ background: pageBg }}>
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* ── Table ── */}
        <div className="rounded-xl overflow-x-auto" style={{ border: `1px solid ${cardBorder}` }}>
          <div className="min-w-[800px]">

            {/* Head */}
            <div className="grid gap-3 px-5 py-3 text-xs font-medium uppercase tracking-wider"
              style={{
                gridTemplateColumns: 'minmax(180px, 2fr) 110px 140px 80px 80px 80px 100px 30px',
                background: headBg,
              ...
              (sorted || []).map((c, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="whitespace-nowrap" style={{ color: textMid }}>{CHANNEL_ICON[c.channel]} {c.channel}</span>
                    <span className="text-xs whitespace-nowrap" style={{ color: textSub }}>{fmtDate(c.created_at)}</span>
                    ...
                    <span className="flex items-center gap-1.5 whitespace-nowrap" style={{ color: sm.color }}>
